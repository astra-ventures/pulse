...
class PonsConfig:
    ...
    stillness_threshold: float = 3.0       # All drives must be below this (lowered from 2.0)
    sustained_minutes: int = 10            # How long drives must stay quiet (lowered from 30)
