...
def detect_contagion(message_text: str, sender: str) -> Optional[dict]:
    ...
    _CONTAGION_MAP = {
        ...
        "frustration": (
            ["frustrated", "annoyed", "ugh", "broken", "stupid", "hate", "angry"],
            -1.5,
            7.5,
        ),
        "sadness": (
            ["sad", "miss", "lonely", "heartbroken", "crying", "devastating"],
            -2.0,
            8.0,
        ),
        "excitement": (
            ["can't wait", "so excited", "incredible", "blown away", "pumped"],
            2.0,
            8.0,
        ),
        "anxiety": (
            ["worried", "scared", "nervous", "anxious", "freaking out", "panic"],
            -1.0,
            7.5,
        ),
        "warmth": (
            ["thank you", "appreciate", "grateful", "means a lot", "love you"],
            2.0,
            7.5,
        ),
    }
